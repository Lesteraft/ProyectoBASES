...
ALTER TABLE tbl_administradores ADD CONSTRAINT tbl_administradores__un UNIQUE ( codigo_persona );

CREATE TABLE tbl_audios (
    codigo_pelicula      INTEGER NOT NULL,
    codigo_audio         INTEGER NOT NULL,
    codigo_idioma        INTEGER NOT NULL,
    nombre_audio         VARCHAR2(20) NOT NULL,
    ruta_archivo_audio   VARCHAR2(50) NOT NULL
);
...
CREATE TABLE tbl_busquedas (
    ...
    codigo_perfil          INTEGER NOT NULL,
    descripcion_busqueda   VARCHAR2(50) NOT NULL,
    fecha                  DATE NOT NULL
);
...
CREATE TABLE tbl_clasificaciones (
    codigo_clasificacion   INTEGER NOT NULL,
    nombre_clasificacion   VARCHAR2(100)
);
...
CREATE TABLE tbl_clasificaciones_x_edad (
    codigo_clasificacion   INTEGER NOT NULL,
    nombre_clasificacion   VARCHAR2(50)
);
...
CREATE TABLE tbl_codigos_promocionales (
    ...
    nombre_promocion     VARCHAR2(30) NOT NULL,
...
CREATE TABLE tbl_configuraciones (
    ...
    codigo_perfil          INTEGER NOT NULL,
    nombre_configuracion   VARCHAR2(15),
    fecha                  DATE
);
...
CREATE TABLE tbl_controles_parentales (
    ...
    nombre_control_parental   VARCHAR2(20),
    codigo_cuenta             INTEGER NOT NULL
);
...
ALTER TABLE tbl_cuentas ADD CONSTRAINT tbl_cuentas__un UNIQUE ( codigo_persona );

ALTER TABLE tbl_cuentas ADD CONSTRAINT tbl_cuentas__unv1 UNIQUE ( codigo_metodo_pago );
...
CREATE TABLE tbl_directore_x_serie (
    código_serie      INTEGER NOT NULL,
    codigo_director   INTEGER NOT NULL,
    fecha             DATE
);

ALTER TABLE tbl_directore_x_serie ADD CONSTRAINT tbl_directore_x_serie_pk PRIMARY KEY ( codigo_director,
                                                                                        código_serie );

CREATE TABLE tbl_directores (
    codigo_director   INTEGER NOT NULL,
    nombre_director   VARCHAR2(50),
    nacimiento        DATE
);
...
CREATE TABLE tbl_guinistas_x_serie (
    código_serie       INTEGER NOT NULL,
    codigo_guionista   INTEGER NOT NULL,
    fecha              DATE
);

ALTER TABLE tbl_guinistas_x_serie ADD CONSTRAINT tbl_guinistasxepisodio_pk PRIMARY KEY ( codigo_guionista,
                                                                                         código_serie );

CREATE TABLE tbl_guionistas (
    codigo_guionista   INTEGER NOT NULL,
    nombre_guionista   VARCHAR2(50),
    nacimiento         DATE,
...
CREATE TABLE tbl_metodos_de_pago (
    codigo_metodo_pago   INTEGER NOT NULL,
    nombre_metodo_pago   VARCHAR2(20)
);

ALTER TABLE tbl_metodos_de_pago ADD CONSTRAINT tbl_metodos_de_pago_pk PRIMARY KEY ( codigo_metodo_pago );
...
CREATE TABLE tbl_perfiles_x_dispositivo (
    codigo_perfil        INTEGER NOT NULL,
    codigo_dispositivo   INTEGER NOT NULL
);

ALTER TABLE tbl_perfiles_x_dispositivo ADD CONSTRAINT tbl_perfiles_x_dispositivo_pk PRIMARY KEY ( codigo_dispositivo,
                                                                                                  codigo_perfil );
...
CREATE TABLE tbl_plataformas (
    codigo_plataforma   INTEGER NOT NULL,
    nombre_plataforma   VARCHAR2(30) NOT NULL
);
...
CREATE TABLE tbl_subtitulos (
    ...
    nombre_subtitulo         VARCHAR2(50),
    ruta_archivo_subtitulo   VARCHAR2(100) NOT NULL
);
...
ALTER TABLE tbl_tarjetas ADD CONSTRAINT tbl_tarjetas_pk PRIMARY KEY ( codigo_cuenta );
...
CREATE TABLE tbl_valoraciones (
    codigo_valoracion   INTEGER NOT NULL,
    nombre_valoracion   VARCHAR2(15)
);

ALTER TABLE tbl_valoraciones ADD CONSTRAINT tbl_like_pkv1 PRIMARY KEY ( codigo_valoracion );

ALTER TABLE tbl_actores_x_pelicula
    ADD CONSTRAINT actores_fk FOREIGN KEY ( codigo_actor )
        REFERENCES tbl_actores ( codigo_actor );

ALTER TABLE tbl_actores_x_serie
    ADD CONSTRAINT actores_fkv2 FOREIGN KEY ( codigo_actor )
        REFERENCES tbl_actores ( codigo_actor );

ALTER TABLE tbl_peliculas
    ADD CONSTRAINT administradores_fk FOREIGN KEY ( codigo_administrador )
        REFERENCES tbl_administradores ( codigo_administrador );

ALTER TABLE tbl_series
    ADD CONSTRAINT administradores_fkv2 FOREIGN KEY ( codigo_administrador )
        REFERENCES tbl_administradores ( codigo_administrador );

ALTER TABLE tb_perfiles
    ADD CONSTRAINT clasificación_fk FOREIGN KEY ( codigo_clasificacion )
        REFERENCES tbl_clasificaciones ( codigo_clasificacion );

ALTER TABLE tbl_peliculas
    ADD CONSTRAINT clasificaciones_x_edad_fk FOREIGN KEY ( codigo_clasificacion )
        REFERENCES tbl_clasificaciones_x_edad ( codigo_clasificacion );

ALTER TABLE tb_perfiles
    ADD CONSTRAINT cuenta_fk FOREIGN KEY ( codigo_cuenta )
        REFERENCES tbl_cuentas ( codigo_cuenta );

ALTER TABLE tbl_controles_parentales
    ADD CONSTRAINT cuenta_fkv2 FOREIGN KEY ( codigo_cuenta )
        REFERENCES tbl_cuentas ( codigo_cuenta );

ALTER TABLE tbl_pagos
    ADD CONSTRAINT cuenta_fkv3 FOREIGN KEY ( codigo_cuenta )
        REFERENCES tbl_cuentas ( codigo_cuenta );

ALTER TABLE tbl_tarjetas
    ADD CONSTRAINT cuenta_fkv4 FOREIGN KEY ( codigo_cuenta )
        REFERENCES tbl_cuentas ( codigo_cuenta );

ALTER TABLE tbl_directore_x_serie
    ADD CONSTRAINT director_fk FOREIGN KEY ( codigo_director )
        REFERENCES tbl_directores ( codigo_director );

ALTER TABLE tbl_directores_x_pelicula
    ADD CONSTRAINT director_fkv2 FOREIGN KEY ( codigo_director )
        REFERENCES tbl_directores ( codigo_director );
...
ALTER TABLE tbl_perfiles_x_dispositivo
    ADD CONSTRAINT dispositivos_fkv2 FOREIGN KEY ( codigo_dispositivo )
        REFERENCES tbl_dispositivos ( codigo_dispositivo );

ALTER TABLE tbl_reacciones
    ADD CONSTRAINT episodios_fk FOREIGN KEY ( codigo_episodio )
        REFERENCES tbl_episodios ( codigo_episodio );

ALTER TABLE tbl_reproducciones
    ADD CONSTRAINT episodios_fkv2 FOREIGN KEY ( codigo_episodio )
        REFERENCES tbl_episodios ( codigo_episodio );

ALTER TABLE tbl_series
    ADD CONSTRAINT estados_series_fk FOREIGN KEY ( codigo_estado )
        REFERENCES tbl_estados_series ( codigo_estado );

ALTER TABLE tbl_generos_x_peliculas
    ADD CONSTRAINT generos_cine_fk FOREIGN KEY ( tbl_generos_cine_codigo_genero )
        REFERENCES tbl_generos_cine ( codigo_genero );

ALTER TABLE tbl_generos_x_series
    ADD CONSTRAINT generos_serie_cine_fk FOREIGN KEY ( tbl_generos_cine_codigo_genero )
        REFERENCES tbl_generos_cine ( codigo_genero );

ALTER TABLE tbl_guinistas_x_serie
    ADD CONSTRAINT guionistas_fk FOREIGN KEY ( codigo_guionista )
        REFERENCES tbl_guionistas ( codigo_guionista );

ALTER TABLE tbl_guionistas_x_pelicula
    ADD CONSTRAINT guionistas_fkv2 FOREIGN KEY ( codigo_guionista )
        REFERENCES tbl_guionistas ( codigo_guionista );

ALTER TABLE tb_perfiles
    ADD CONSTRAINT idioma_fk FOREIGN KEY ( codigo_idioma )
        REFERENCES tbl_idiomas ( codigo_idioma );

ALTER TABLE tbl_audios
    ADD CONSTRAINT idioma_fkv2 FOREIGN KEY ( codigo_idioma )
        REFERENCES tbl_idiomas ( codigo_idioma );

ALTER TABLE tbl_codigos_promocionales
    ADD CONSTRAINT metodos_de_pago_fk FOREIGN KEY ( codigo_metodo_pago )
        REFERENCES tbl_metodos_de_pago ( codigo_metodo_pago );

ALTER TABLE tbl_cuentas
    ADD CONSTRAINT metodos_de_pago_fkv2 FOREIGN KEY ( codigo_metodo_pago )
        REFERENCES tbl_metodos_de_pago ( codigo_metodo_pago );

ALTER TABLE tbl_tarjetas
    ADD CONSTRAINT metodos_de_pago_fkv3 FOREIGN KEY ( codigo_metodo_pago )
        REFERENCES tbl_metodos_de_pago ( codigo_metodo_pago );

ALTER TABLE tb_perfiles
    ADD CONSTRAINT parentales_fk FOREIGN KEY ( codigo_control_parental )
        REFERENCES tbl_controles_parentales ( codigo_control_parental );

ALTER TABLE tbl_actores_x_pelicula
    ADD CONSTRAINT peliculas_fk FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_audios
    ADD CONSTRAINT peliculas_fkv2 FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_directores_x_pelicula
    ADD CONSTRAINT peliculas_fkv3 FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_generos_x_peliculas
    ADD CONSTRAINT peliculas_fkv4 FOREIGN KEY ( tbl_peliculas_codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_guionistas_x_pelicula
    ADD CONSTRAINT peliculas_fkv5 FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_listas
    ADD CONSTRAINT peliculas_fkv6 FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_reacciones
    ADD CONSTRAINT peliculas_fkv7 FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_reproducciones
    ADD CONSTRAINT peliculas_fkv8 FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_subtitulos
    ADD CONSTRAINT peliculas_fkv9 FOREIGN KEY ( codigo_pelicula )
        REFERENCES tbl_peliculas ( codigo_pelicula );

ALTER TABLE tbl_busquedas
    ADD CONSTRAINT perfil_fk FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_configuraciones
    ADD CONSTRAINT perfil_fkv2 FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_descargas
    ADD CONSTRAINT perfil_fkv3 FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_perfiles_x_dispositivo
    ADD CONSTRAINT perfil_fkv4 FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_reacciones
    ADD CONSTRAINT perfil_fkv5 FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_reproducciones
    ADD CONSTRAINT perfil_fkv6 FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_administradores
    ADD CONSTRAINT personas_fk FOREIGN KEY ( codigo_persona )
        REFERENCES tbl_personas ( codigo_persona );

ALTER TABLE tbl_cuentas
    ADD CONSTRAINT personas_fkv2 FOREIGN KEY ( codigo_persona )
        REFERENCES tbl_personas ( codigo_persona );

ALTER TABLE tbl_cuentas
    ADD CONSTRAINT planes_fk FOREIGN KEY ( codigo_plan )
        REFERENCES tbl_planes ( codigo_plan );

ALTER TABLE tbl_dispositivos
    ADD CONSTRAINT plataformas_fk FOREIGN KEY ( codigo_plataforma )
        REFERENCES tbl_plataformas ( codigo_plataforma );

ALTER TABLE tb_perfiles
    ADD CONSTRAINT region_fk FOREIGN KEY ( codigo_lugar )
        REFERENCES tbl_regiones ( codigo_lugar );

ALTER TABLE tbl_regiones
    ADD CONSTRAINT regiones_fk FOREIGN KEY ( codigo_lugar_padre )
        REFERENCES tbl_regiones ( codigo_lugar );

ALTER TABLE tbl_actores_x_serie
    ADD CONSTRAINT series_fk FOREIGN KEY ( código_serie )
        REFERENCES tbl_series ( código_serie );

ALTER TABLE tbl_directore_x_serie
    ADD CONSTRAINT series_fkv2 FOREIGN KEY ( código_serie )
        REFERENCES tbl_series ( código_serie );

ALTER TABLE tbl_generos_x_series
    ADD CONSTRAINT series_fkv3 FOREIGN KEY ( tbl_series_código_serie )
        REFERENCES tbl_series ( código_serie );

ALTER TABLE tbl_guinistas_x_serie
    ADD CONSTRAINT series_fkv4 FOREIGN KEY ( código_serie )
        REFERENCES tbl_series ( código_serie );

ALTER TABLE tbl_listas
    ADD CONSTRAINT series_fkv5 FOREIGN KEY ( código_serie )
        REFERENCES tbl_series ( código_serie );

ALTER TABLE tbl_reacciones
    ADD CONSTRAINT series_fkv6 FOREIGN KEY ( código_serie )
        REFERENCES tbl_series ( código_serie );

ALTER TABLE tbl_temporada
    ADD CONSTRAINT series_fkv7 FOREIGN KEY ( código_serie )
        REFERENCES tbl_series ( código_serie );

ALTER TABLE tbl_listas
    ADD CONSTRAINT tb_perfil_fk FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_notificaciones
    ADD CONSTRAINT tb_perfil_fkv2 FOREIGN KEY ( tb_perfil_codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );

ALTER TABLE tbl_episodios
    ADD CONSTRAINT temporada_fk FOREIGN KEY ( cadigo_temporada )
        REFERENCES tbl_temporada ( cadigo_temporada );

ALTER TABLE tbl_listas
    ADD CONSTRAINT temporada_fkv2 FOREIGN KEY ( cadigo_temporada )
        REFERENCES tbl_temporada ( cadigo_temporada );

ALTER TABLE tbl_peliculas
    ADD CONSTRAINT valoracion_fk FOREIGN KEY ( codigo_valoracion )
        REFERENCES tbl_valoraciones ( codigo_valoracion );
