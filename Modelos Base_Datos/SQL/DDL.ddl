...
CREATE TABLE tbl_metodos_de_pago (
    codigo_metodo_pago   INTEGER NOT NULL,
    nombre_metodo_pago   DATE NOT NULL
);
...
CREATE TABLE tbl_regiones (
    ...
    latitud              VARCHAR2(200) NOT NULL,
    longitud             VARCHAR2(200) NOT NULL
);
...
CREATE TABLE tbl_valoraciones (
    codigo_valoracion   INTEGER NOT NULL,
    nombre_valoracion   VARCHAR2(200) NOT NULL
);
...
ALTER TABLE tbl_administradores
    ADD CONSTRAINT t_admin_t_person_fk FOREIGN KEY ( codigo_persona )
...
ALTER TABLE tbl_codigos_promocionales
    ADD CONSTRAINT t_cod_promo_t_m_pago_fk FOREIGN KEY ( codigo_metodo_pago )
...
ALTER TABLE tbl_cuentas
    ADD CONSTRAINT t_cuenta_t_m_de_pago_fk FOREIGN KEY ( codigo_metodo_pago )
        REFERENCES tbl_metodos_de_pago ( codigo_metodo_pago );

ALTER TABLE tbl_cuentas
    ADD CONSTRAINT t_cuenta_t_personas_fk FOREIGN KEY ( codigo_persona )
        REFERENCES tbl_personas ( codigo_persona );
...
ALTER TABLE tbl_peliculas
    ADD CONSTRAINT t_peli_t_valoracion_fk FOREIGN KEY ( codigo_valoracion )
        REFERENCES tbl_valoraciones ( codigo_valoracion );

ALTER TABLE tb_perfiles
    ADD CONSTRAINT t_perfil_t_clasifi_fk FOREIGN KEY ( codigo_clasificacion )
        REFERENCES tbl_clasificaciones ( codigo_clasificacion );

ALTER TABLE tb_perfiles
    ADD CONSTRAINT t_perfil_t_control_parent_fk FOREIGN KEY ( codigo_control_parental )
        REFERENCES tbl_controles_parentales ( codigo_control_parental );

ALTER TABLE tbl_perfiles_x_dispositivo
    ADD CONSTRAINT t_perfil_x_devi_t_devices_fk FOREIGN KEY ( codigo_dispositivo )
        REFERENCES tbl_dispositivos ( codigo_dispositivo );

ALTER TABLE tbl_perfiles_x_dispositivo
    ADD CONSTRAINT t_perfil_x_devi_t_perfil_fk FOREIGN KEY ( codigo_perfil )
        REFERENCES tb_perfiles ( codigo_perfil );
...
ALTER TABLE tbl_tarjetas
    ADD CONSTRAINT t_tarjetas_t_cuenta_fk FOREIGN KEY ( codigo_cuenta )
        REFERENCES tbl_cuentas ( codigo_cuenta );

ALTER TABLE tbl_tarjetas
    ADD CONSTRAINT t_tarjetas_t_m_de_pago_fk FOREIGN KEY ( codigo_metodo_pago )
        REFERENCES tbl_metodos_de_pago ( codigo_metodo_pago );
