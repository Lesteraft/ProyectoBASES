<?php
 ...
 if(isset($_POST['nombre'])){
     ...
     $sql = "BEGIN UPLOAD_PELI(peliculas_seq.nextval, 1, ".$_POST["clasificacion"].", 1, '".$_POST["nombre"]."', '".$_POST["resenia"]."',TO_DATE('".$_POST["fecha"]."', 'DD/MM/YYYY'), 0,'".$_POST["urlVideo"]."', '".$_POST["urlImagen1"]."', '".$_POST["urlImagen2"]."'); END;";
